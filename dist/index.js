...
left === null || left === void 0 ? void 0 : left.addEventListener("click", () => chooseMode(left.className));
right === null || right === void 0 ? void 0 : right.addEventListener("click", () => chooseMode(right.className));
const enterGame = () => {
...
const renderGame = () => {
    ...
    const p1_list = document.createElement("div");
    const p2_list = document.createElement("div");
...
const gameMainProcess = () => {
    const readyButton1 = document.getElementById("p1");
    const readyButton2 = document.getElementById("p2");
    let playerState = [
        {
            ready: false,
            choosedHand: "",
    ...
    document.body.addEventListener("keypress", (e) => {
        ...
        if (playerState[0].ready === true && playerState[1].ready === true) {
            ...
            if (playerState[0].choosedHand === "✊") {
                if (playerState[1].choosedHand === "✌")
                    winner = "Player 1";
                else if (playerState[1].choosedHand === "✋")
                    winner = "Player 2";
                else
                    winner = "Draw";
            }
            ...
            p1.innerHTML = "";
            p2.innerHTML = "";
            p1 === null || p1 === void 0 ? void 0 : p1.appendChild(h1p1);
            p2 === null || p2 === void 0 ? void 0 : p2.appendChild(h1p2);
